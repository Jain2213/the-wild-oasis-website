...
import { generateBookings } from "../_lib/action";
...
function ReservationForm({maxCapacity, session, cabin}) {
  ...
  return (
    <div className='scale-[1.01]'>
      ...
      <form className='bg-primary-900 py-10 px-16 text-lg flex gap-5 flex-col' action={generateBookings.bind(null, bookingsData)}>
